...
if (typeof args.mode === "undefined") args.mode = "production";
if (args.mode !== "production" && args.mode !== "development") throw new Error("--mode can only be 'development' or 'production'");
